...
def test_json2Packets():
   ...
   assert_json_eq_hex({"206":{"time":-5,"hold":True}}, ["71 00 00 7e 0c"])  ## check time max
   ...
   assert_json_eq_hex({"211":{"left_cm_s":13.5}}, ["01 01 94 00 00"])
   assert_json_eq_hex({"211":{"right_cm_s":-13.5}}, ["01 00 00 fe 6c"])
